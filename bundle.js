...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"initProxy\": () => (/* binding */ initProxy),\n/* harmony export */   \"proxy\": () => (/* binding */ proxy)\n/* harmony export */ });\n/* harmony import */ var _components_MovieContainer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/MovieContainer */ \"./src/components/MovieContainer.ts\");\n/* harmony import */ var _components_templates_movieContainer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/templates/movieContainer */ \"./src/components/templates/movieContainer.ts\");\n/* harmony import */ var _components_templates_movieItem__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/templates/movieItem */ \"./src/components/templates/movieItem.ts\");\n/* harmony import */ var _components_templates_movieList__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/templates/movieList */ \"./src/components/templates/movieList.ts\");\n/* harmony import */ var _utils_dom__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/dom */ \"./src/utils/dom.ts\");\n/* harmony import */ var _movieApi__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./movieApi */ \"./src/domains/movieApi.ts\");\n\n\n\n\n\n\nconst proxy = {\n    query: { value: '', isSearch: false },\n    moreButton: { isClick: false, currentPage: 1, isSearch: false },\n};\nconst initProxy = (appProps) => {\n    proxy.query = new Proxy(appProps.query, {\n        set: (target, props, value) => {\n            if (props === 'value') {\n                target.props = value;\n                const instance = new _components_MovieContainer__WEBPACK_IMPORTED_MODULE_0__[\"default\"]((0,_components_templates_movieContainer__WEBPACK_IMPORTED_MODULE_1__.showMovieContainer)({ className: 'item-view', id: 'item-view', query: value }));\n                const container = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_4__.$)('#item-view');\n                if (container instanceof HTMLElement) {\n                    _movieApi__WEBPACK_IMPORTED_MODULE_5__.movieApi.fetchMovieList({ query: value, currentPage: 1 }).then(data => {\n                        const results = data.results;\n                        const cardTemplateList = results\n                            .map(item => (0,_components_templates_movieItem__WEBPACK_IMPORTED_MODULE_2__.showMovieItemTemplate)({ src: item.poster_path, title: item.title, score: item.vote_average }))\n                            .join('');\n                        instance.renderChild(container, `\n\t\t\t\t\t\t\t<h2>\"${value}\" 검색 결과</h2>${(0,_components_templates_movieList__WEBPACK_IMPORTED_MODULE_3__.showMovieList)({ className: 'item-list', cardTemplateList })}\n\t\t\t\t\t\t\t<button class=\"btn primary full-width\" id=\"moreButton\">더 보기</button>\n\t\t\t\t\t\t\t`);\n                    });\n                }\n            }\n            return true;\n        },\n    });\n    proxy.moreButton = new Proxy(appProps.moreButton, {\n        set: (target, props, value) => {\n            if (props === 'isClick' && value) {\n                target.props = value;\n                const instance = new _components_MovieContainer__WEBPACK_IMPORTED_MODULE_0__[\"default\"]((0,_components_templates_movieContainer__WEBPACK_IMPORTED_MODULE_1__.showMovieContainer)({ className: 'item-view', id: 'item-view', query: '' }));\n                const container = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_4__.$)('#item-view');\n                if (container instanceof HTMLElement) {\n                    if (proxy.query.isSearch) {\n                        if (proxy.query.value) {\n                            _movieApi__WEBPACK_IMPORTED_MODULE_5__.movieApi.searchMovieList(proxy.query.value, proxy.moreButton.currentPage + 1).then(data => {\n                                const results = data.results;\n                                const cardTemplateList = results\n                                    .map(item => (0,_components_templates_movieItem__WEBPACK_IMPORTED_MODULE_2__.showMovieItemTemplate)({ src: item.poster_path, title: item.title, score: item.vote_average }))\n                                    .join('');\n                                instance.renderChild(container, `<h2>${`\"${proxy.query.value}\" 검색 결과`}</h2>${(0,_components_templates_movieList__WEBPACK_IMPORTED_MODULE_3__.showMovieList)({\n                                    className: 'item-list',\n                                    cardTemplateList,\n                                })}\n\t\t\t\t\t\t\t\t\t<button class=\"btn primary full-width\" id=\"moreButton\">더 보기</button>`);\n                                target.currentPage++;\n                            });\n                        }\n                    }\n                    else {\n                        _movieApi__WEBPACK_IMPORTED_MODULE_5__.movieApi.getMoreMovieList(proxy.moreButton.currentPage).then(data => {\n                            const results = data.results;\n                            const cardTemplateList = results\n                                .map(item => (0,_components_templates_movieItem__WEBPACK_IMPORTED_MODULE_2__.showMovieItemTemplate)({ src: item.poster_path, title: item.title, score: item.vote_average }))\n                                .join('');\n                            instance.renderChild(container, `<h2>${proxy.query.value === '' ? '지금 인기 있는 영화' : `\"${proxy.query.value}\" 검색 결과`}</h2>${(0,_components_templates_movieList__WEBPACK_IMPORTED_MODULE_3__.showMovieList)({\n                                className: 'item-list',\n                                cardTemplateList,\n                            })}\n\t\t\t\t\t\t\t\t\t<button class=\"btn primary full-width\" id=\"moreButton\">더 보기</button>`);\n                            target.currentPage++;\n                        });\n                    }\n                }\n                target.props = false;\n            }\n            return true;\n        },\n    });\n};\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/domains/proxy.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _utils_dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/dom */ \"./src/utils/dom.ts\");\n/* harmony import */ var _components_MovieContainer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../components/MovieContainer */ \"./src/components/MovieContainer.ts\");\n/* harmony import */ var _components_shared_CardList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/shared/CardList */ \"./src/components/shared/CardList.ts\");\n/* harmony import */ var _components_shared_Button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components/shared/Button */ \"./src/components/shared/Button.ts\");\n/* harmony import */ var _domains_proxy__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../domains/proxy */ \"./src/domains/proxy.ts\");\n\n\n\n\n\nclass Main {\n    constructor({ movieContainer, movieList, moreButton }) {\n        this.components = {\n            movieContainer: null,\n            movieList: null,\n            moreButton: null,\n        };\n        this.components = { movieContainer, movieList, moreButton };\n    }\n    render() {\n        const appElement = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.$)('#app');\n        if (appElement instanceof HTMLDivElement && appElement.closest('body')) {\n            appElement.insertAdjacentHTML('beforeend', '<main></main>');\n            this.renderChild();\n            this.listenEvent('click');\n        }\n    }\n    renderChild() {\n        const mainElement = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.$)('main');\n        if (mainElement instanceof HTMLElement &&\n            mainElement.closest('body') &&\n            this.components.movieContainer instanceof _components_MovieContainer__WEBPACK_IMPORTED_MODULE_1__[\"default\"]) {\n            this.components.movieContainer.render(mainElement);\n            const movieContainerElement = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.$)('section');\n            if (movieContainerElement instanceof HTMLElement &&\n                movieContainerElement.closest('main') &&\n                this.components.movieList instanceof _components_shared_CardList__WEBPACK_IMPORTED_MODULE_2__[\"default\"] &&\n                this.components.moreButton instanceof _components_shared_Button__WEBPACK_IMPORTED_MODULE_3__[\"default\"]) {\n                this.components.movieList.render(movieContainerElement);\n                this.components.moreButton.render(movieContainerElement);\n            }\n        }\n    }\n    callback(event) {\n        if (event.target instanceof HTMLButtonElement && event.target.matches('#moreButton')) {\n            _domains_proxy__WEBPACK_IMPORTED_MODULE_4__.proxy.moreButton.isClick = true;\n        }\n    }\n    listenEvent(type) {\n        const mainElement = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.$)('main');\n        if (mainElement instanceof HTMLElement) {\n            mainElement.addEventListener(type, this.callback.bind(this));\n        }\n    }\n}\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Main);\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/pages/main/Main.ts?");

/***/ }),

/***/ "./src/pages/pageRender.ts":
/*!*********************************!*\
  !*** ./src/pages/pageRender.ts ***!
  \*********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"pageRender\": () => (/* binding */ pageRender)\n/* harmony export */ });\n/* harmony import */ var _assets_images__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../assets/images */ \"./src/assets/images.ts\");\n/* harmony import */ var _components_MovieContainer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/MovieContainer */ \"./src/components/MovieContainer.ts\");\n/* harmony import */ var _components_shared_Button__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/shared/Button */ \"./src/components/shared/Button.ts\");\n/* harmony import */ var _components_shared_CardList__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/shared/CardList */ \"./src/components/shared/CardList.ts\");\n/* harmony import */ var _components_shared_Form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/shared/Form */ \"./src/components/shared/Form.ts\");\n/* harmony import */ var _components_shared_Logo__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/shared/Logo */ \"./src/components/shared/Logo.ts\");\n/* harmony import */ var _components_templates_logo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/templates/logo */ \"./src/components/templates/logo.ts\");\n/* harmony import */ var _components_templates_movieContainer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/templates/movieContainer */ \"./src/components/templates/movieContainer.ts\");\n/* harmony import */ var _components_templates_movieItem__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/templates/movieItem */ \"./src/components/templates/movieItem.ts\");\n/* harmony import */ var _components_templates_movieList__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/templates/movieList */ \"./src/components/templates/movieList.ts\");\n/* harmony import */ var _components_templates_searchBox__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../components/templates/searchBox */ \"./src/components/templates/searchBox.ts\");\n/* harmony import */ var _components_templates_showMoreButton__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../components/templates/showMoreButton */ \"./src/components/templates/showMoreButton.ts\");\n/* harmony import */ var _domains_MovieListManager__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../domains/MovieListManager */ \"./src/domains/MovieListManager.ts\");\n/* harmony import */ var _header_Header__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./header/Header */ \"./src/pages/header/Header.ts\");\n/* harmony import */ var _main_Main__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./main/Main */ \"./src/pages/main/Main.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nconst pageRender = {\n    renderHeader() {\n        const header = new _header_Header__WEBPACK_IMPORTED_MODULE_13__[\"default\"]({\n            logo: new _components_shared_Logo__WEBPACK_IMPORTED_MODULE_5__[\"default\"]((0,_components_templates_logo__WEBPACK_IMPORTED_MODULE_6__.showLogoTemplate)({ id: 'logo', src: _assets_images__WEBPACK_IMPORTED_MODULE_0__.IMAGES.LOGO, alt: 'MovieList 로고' })),\n            searchBox: new _components_shared_Form__WEBPACK_IMPORTED_MODULE_4__[\"default\"]((0,_components_templates_searchBox__WEBPACK_IMPORTED_MODULE_10__.showSearchBoxTemplate)({\n                className: 'search-box',\n                id: 'search-box',\n                inputId: 'search-input',\n                placeholder: '검색',\n            })),\n        });\n        header.render();\n    },\n    renderMainContents() {\n        return __awaiter(this, void 0, void 0, function* () {\n            const movieListManager = _domains_MovieListManager__WEBPACK_IMPORTED_MODULE_12__[\"default\"].getInstance();\n            yield movieListManager.fetchMovieList();\n            const cardTemplateList = movieListManager\n                .getMovieList()\n                .map(item => (0,_components_templates_movieItem__WEBPACK_IMPORTED_MODULE_8__.showMovieItemTemplate)({ src: item.poster_path, title: item.title, score: item.vote_average }))\n                .join('');\n            const main = new _main_Main__WEBPACK_IMPORTED_MODULE_14__[\"default\"]({\n                movieContainer: new _components_MovieContainer__WEBPACK_IMPORTED_MODULE_1__[\"default\"]((0,_components_templates_movieContainer__WEBPACK_IMPORTED_MODULE_7__.showMovieContainer)({ className: 'item-view', id: 'item-view', query: '' })),\n                movieList: new _components_shared_CardList__WEBPACK_IMPORTED_MODULE_3__[\"default\"]((0,_components_templates_movieList__WEBPACK_IMPORTED_MODULE_9__.showMovieList)({ className: 'item-list', cardTemplateList })),\n                moreButton: new _components_shared_Button__WEBPACK_IMPORTED_MODULE_2__[\"default\"]((0,_components_templates_showMoreButton__WEBPACK_IMPORTED_MODULE_11__.showMoreButtonTemplate)()),\n            });\n            main.render();\n        });\n    },\n};\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/pages/pageRender.ts?");
